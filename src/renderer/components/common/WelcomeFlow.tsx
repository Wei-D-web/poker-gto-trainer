 ...
 * 3-step onboarding: welcome → game type → starting point.
 *
...
type Step = 'welcome' | 'game-type' | 'start'
    ...
    <div className="fixed inset-0 z-[400] bg-[#05080C] flex items-center justify-center p-6">
      ...
      <div className="w-full max-w-md relative z-10">
        ...
        <div className="flex items-center justify-center gap-2 mb-10">
          {(['welcome', 'game-type', 'start'] as Step[]).map((s, i) => (
              ...
              <div
                className={cn(
                  ...
                  step === s
                    ...
                    : ['welcome', 'game-type', 'start'].indexOf(step) > i
          ...
          {step === 'start' && (
            <div className="text-center space-y-6">
              <div className="space-y-2">
                ...
                <p className="text-sm text-neutral-500">任何模块都可以随时切换</p>
              </div>

              <div className="grid gap-3">
                {[
                  { id: 'explore', label: '翻前范围训练', desc: '查看 GTO 翻前范围矩阵', icon: Target, color: 'text-blue-400' },
                  { id: 'analyzer', label: '手牌分析', desc: '分析你的手牌决策偏差', icon: Search, color: 'text-cyan-400' },
                  { id: 'playground', label: '实战模拟', desc: '对抗 GTO AI，真实牌桌体验', icon: Play, color: 'text-emerald-400' },
                ].map((opt) => (
                  <button
                    key={opt.id}
                  ...
                  >
                    ...
                    <div className="flex-1">
                      <div className="font-semibold text-sm text-neutral-200">{opt.label}</div>
                      <div className="text-xs text-neutral-500">{opt.desc}</div>
                    </div>
