...
export const ACTION_LABELS: ActionLabel[] = [
  ...
  { id: 'check', shortLabel: 'X', fullLabel: 'Check', type: 'check', color: '#A78BFA' },
  ...
  { id: 'bet_66', shortLabel: 'B66', fullLabel: 'Bet 66%', type: 'bet', color: '#FB923C' },
  { id: 'bet_75', shortLabel: 'B75', fullLabel: 'Bet 75%', type: 'bet', color: '#F97316' },
  { id: 'bet_100', shortLabel: 'B100', fullLabel: 'Bet 100%', type: 'bet', color: '#EA580C' },
  { id: 'bet_125', shortLabel: 'B125', fullLabel: 'Bet 125%', type: 'bet', color: '#D97706' },
  { id: 'bet_150', shortLabel: 'B150', fullLabel: 'Bet 150%', type: 'bet', color: '#B45309' },
  { id: 'bet_200', shortLabel: 'B200', fullLabel: 'Bet 200%', type: 'bet', color: '#92400E' },
  ...
  { id: 'raise_3x', shortLabel: 'R3x', fullLabel: 'Raise 3x', type: 'raise', color: '#B91C1C' },
  { id: 'raise_4x', shortLabel: 'R4x', fullLabel: 'Raise 4x', type: 'raise', color: '#991B1B' },
  { id: 'all_in', shortLabel: 'AI', fullLabel: 'All In', type: 'all_in', color: '#991B1B' },
]
